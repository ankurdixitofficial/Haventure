    ...
    <footer className="bg-gray-100 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="flex flex-wrap justify-center -mx-5 -my-2">
          ...
          <div className="px-5 py-2">
            <Link href="/properties" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
              Properties
            </Link>
          </div>
          <div className="px-5 py-2">
          ...
          <div className="px-5 py-2">
            <Link href="/terms" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
              Terms
            </Link>
          </div>
        </nav>
        ...
        <p className="mt-8 text-center text-base text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()} Haventure, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
